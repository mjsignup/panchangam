...
%\newcommand{\SUNDAY}{\textsf{भानु}}
%\newcommand{\MONDAY}{\textsf{इन्दु}}
%\newcommand{\TUESDAY}{\textsf{भौम}}
%\newcommand{\WEDNESDAY}{\textsf{बुध}}
%\newcommand{\THURSDAY}{\textsf{गुरु}}
%\newcommand{\FRIDAY}{\textsf{भृगु}}
%\newcommand{\SATURDAY}{\textsf{स्थिर}}
...
\mbox{}\\[1ex]
\mbox{}
{\font\x="Warnock Pro" at 60 pt\x YEAR\\[0.5cm]}
\mbox{}
{\font\x="Warnock Pro" at 48 pt\x \uppercase{CITY}\\[0.3cm]}
\hrule
\input{FILENAME}
\end{center}
\end{document}
